...
python {baseDir}/visit.py https://example.com/article

# Fetch documentation
python {baseDir}/visit.py https://docs.python.org/3/library/asyncio.html

# Download an image (auto-detected by content-type)
python {baseDir}/visit.py https://example.com/image.png
