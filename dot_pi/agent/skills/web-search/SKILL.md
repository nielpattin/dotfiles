...
```bash
python {baseDir}/search.py "your search query"
```

If your environment has a working `python3` command, this also works:

```bash
python3 {baseDir}/search.py "your search query"
```
...
```bash
# Basic search
python {baseDir}/search.py "python async await tutorial"

# Search for recent news
python {baseDir}/search.py "latest AI developments 2024"

# Find documentation
python {baseDir}/search.py "nodejs fs promises API"
```
